...
<label class="Alerts" for="AlertSection"><a href="/admin/reqsummary" class="alert-link">Requests</a> / Need Attention / Request # <%= cwRequest.getRequestNumber() %> / <%= cwRequest.getRequestType() %></label>
 ...
 <label class="Alerts" for="AlertSection">Request Information</label>   
      <ul class="list-group">
        <li class="list-group-item">Date Needed: <%= cwRequest.getRequestedDateString() %></li>
          <li class="list-group-item">Requested Amount: $<%= cwRequest.getReqestedAmount() %></li>
