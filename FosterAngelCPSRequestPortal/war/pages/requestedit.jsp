...
<form role="form" name="cpsrequest" method="post" action="update" onSubmit="return formValidation();">
...
<label for="relatedFormSection1">Request Information</label>
  ...
  <div class="form-group">
    <label for="supervisor">Desired vVndor</label>
...
<div class="container pagination-centered">
  <button class="btn btn-lg btn-primary btn-block" type="submit">Submit</button>
   ...
   <br />  
  <div class="container pagination-centered">
  <button class="btn btn-lg btn-defult btn-block " type="reset" onclick="location.href='/cwrequest/list/pending'">Cancel</button>
  </div>
</form>
