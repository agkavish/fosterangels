...
<script>
	function csphomeform(actionName) {
		//alert("Action NAme :" actionName);
		document.cpshome.action = actionName;
		document.cpshome .submit();
		return true; 
	}
...
<label class="Alerts" for="AlertSection">Alerts</label>
<div class="AlertSection">



<div class="alert alert-success"> <a href="#" class="alert-link">Request *child first name*'s (*request Number*) </a> Approved</div>

<div class="alert alert-warning"> <a href="#" class="alert-link">Request *child first name*'s (*request Number*) </a>
 needs additional information</div>

<div class="alert alert-danger"> <a href="#" class="alert-link"> Request *child first name*'s (*request Number*) </a> has been denied</div>
...
<div class="container pagination-centered">
  ...
  <br />
  <div class="container pagination-centered">
  <button class="btn btn-lg btn-defult btn-block " type="button" onclick="location.href='/signout'">Sign out</button>
  </div>
