  ...
  <body>
      <%
		...
		if(request.getAttribute("profile")!=null){
			...
			userProfile = (Profile) request.getAttribute("profile");			
		} 	else {
...
<ul class="list-group">
  <li class="list-group-item"><%= userProfile.getEmail() %></li>
  <li class="list-group-item"><%= userProfile.getFirstName() %></li>
  <li class="list-group-item"><%= userProfile.getLastName() %></li>
  <li class="list-group-item"><%= userProfile.getPreferedName() %></li>
  <li class="list-group-item"><%= userProfile.getCellPhone() %></li>
  <li class="list-group-item"><%= userProfile.getWorkPhone() %></li>
 </ul>   
 
 <%
 	if (userProfile.getTitle() != null &&! userProfile.getTitle().equalsIgnoreCase("fa")) {
 %>
 <label class="Alerts" for="AlertSection">Your Supervisor's Info</label>   
      <ul class="list-group">
        <li class="list-group-item"><%= userProfile.getSupervisorFirstName() %></li>
          <li class="list-group-item"><%= userProfile.getSupervisorLastName() %></li>
          <li class="list-group-item"><%= userProfile.getSupervisorEmail() %></li>
          <li class="list-group-item"><%= userProfile.getSupervisorPhone() %></li>
</ul>
<%
 	}
%>
...
<div class="container pagination-centered">
  <button class="btn btn-lg btn-defult btn-block " type="button" onclick="document.cpsprofileview.action = '/profile/edit/<%=KeyFactory.keyToString(userProfile.getKey())%>';document.cpsprofileview.submit();">Edit Profile</button>
  </div>
  <br />
