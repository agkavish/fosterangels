...
<form role="form" name="cpsrequest" method="post" action="add" onSubmit="return formValidation();">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="numChildSupported" id="numChildSupported" placeholder="1" onblur="return allnumeric(this);">
  </div>
  
   <div class="form-group">
    <label for="lastName">Number of Times Family Has Used FACT</label>
    <input type="number" class="form-control" name="numUsedFact" id="numUsedFact" placeholder="00" onblur="return allnumeric(this);">
  </div>
...
<label for="relatedFormSection1">Request Information</label>
   <div class="relatedFormSection">
	...
	<div class="form-group">
    <label for="supervisor">Date Needed</label>
    <input type="date" class="form-control" name="requestDate" id="requestDate" placeholder="mm/dd/yyyy" onblur="return ValidateRequestedDate(this);">
  </div>
