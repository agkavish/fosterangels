...
<label class="Alerts" for="AlertSection"><a href="/cwrequest/summary" class="alert-link">Requests</a> / Receipt Attached</label>
...
%>
<div class="alert alert-success"> <a href="/cwrequest/details/<%=KeyFactory.keyToString(req.getKey())%>" class="alert-link">Request *<%=req.getChildName() %>* (*<%=req.getRequestNumber() %>*) *<%=req.getRequestedDateString()%>*</a> </div>
<%
}
%>
