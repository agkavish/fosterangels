...
<label class="Alerts" for="AlertSection"><a href="/cwrequest/summary" class="alert-link">Requests</a> / <a href="/cwrequest/list/overdue" class="alert-link">Need Attention</a> / Request <%= cwRequest.getRequestNumber() %></label>
