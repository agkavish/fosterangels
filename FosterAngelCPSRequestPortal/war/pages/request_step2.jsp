...
<div class="container">
  ...
  <ul class="nav navbar-right"> <li><a href="/signout">Signout</a></li> </ul>
   ...
   <br />
    <br />
   In compliance with CPS regulations we have sent a confirmation email to your supervisor. Once we receive confirmation from your supervisor you will be contacted with next steps.</h5>
...
<div class="container pagination-centered">
  ...
  <br />
  <div class="container pagination-centered">
  <button class="btn btn-lg btn-primary btn-block " type="button" onclick="location.href='/cpshome'">Home</button>
  </div>
