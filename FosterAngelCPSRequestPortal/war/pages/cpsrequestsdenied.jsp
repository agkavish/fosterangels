...
<label class="Alerts" for="AlertSection"><a href="/cwrequest/summary" class="alert-link">Requests</a> / Denied</label>
...
%>
<div class="alert alert-danger"> <a href="/cwrequest/details/<%=KeyFactory.keyToString(req.getKey())%>" class="alert-link">Request *<%=req.getChildName() %>* (*<%=req.getRequestNumber() %>*) *<%=req.getRequestedDateString()%>*</a> </div>
<%
}
%>
