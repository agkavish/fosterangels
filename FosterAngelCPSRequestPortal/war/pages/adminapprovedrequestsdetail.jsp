...
<label class="Alerts" for="AlertSection"><a href="/admin/reqsummary" class="alert-link">Requests</a> / Approved / Request # <%= cwRequest.getRequestNumber() %> / <%= cwRequest.getRequestType() %> </label>
