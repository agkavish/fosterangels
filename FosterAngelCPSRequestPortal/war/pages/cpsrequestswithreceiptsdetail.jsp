...
<label class="Alerts" for="AlertSection"><a href="/cwrequest/summary" class="alert-link">Requests</a> / <a href="/cwrequest/list/approved" class="alert-link">Receipt Attached</a> / Request <%= cwRequest.getRequestNumber() %></label>
