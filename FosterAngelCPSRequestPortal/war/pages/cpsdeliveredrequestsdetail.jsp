...
<label class="Alerts" for="AlertSection"><a href="/cwrequest/summary" class="alert-link">Requests</a> / <a href="/cwrequest/list/delivered" class="alert-link">Delivered</a> / Request <%= cwRequest.getRequestNumber() %></label>
