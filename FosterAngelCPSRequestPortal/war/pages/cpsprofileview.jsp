...
<ul class="nav nav-pills">
 <li><a href="/cpshome"><img class="" src="/../img/Home.png" alt="" height="20" width="20"></a></li>
  ...
  <%
		if (!uProfile.getTitle().equalsIgnoreCase("ss")){
  %>
...
<ul class="list-group">
  ...
  <li class="list-group-item"><%= uProfile.getUnitNumber() %></li>  
 </ul>  
 
 <label class="Alerts" for="AlertSection">Your Supervisor's Info</label>   
      <ul class="list-group">
        <li class="list-group-item"><%= uProfile.getSupervisorFirstName() %></li>
          <li class="list-group-item"><%= uProfile.getSupervisorLastName() %></li>
          <li class="list-group-item"><%= uProfile.getSupervisorEmail() %></li>
          <li class="list-group-item"><%= uProfile.getSupervisorPhone() %></li>
</ul>
