...
<label class="Alerts" for="AlertSection"><a href="/cwrequest/summary" class="alert-link">Requests</a> / <a href="/cwrequest/list/closed" class="alert-link">Closed</a> / Request <%= cwRequest.getRequestNumber() %></label>
